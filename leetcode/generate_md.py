...
def generate_final_data(section, md_file, new_solution):
		res = "# {}\n\n".format(section)
		res = "{}{}{}\n".format(res, md_file.get_menu(), new_solution.get_md_menu_link())
		res = res + md_file.get_solutions() + new_solution.get_md_title() + new_solution.get_md_link() + new_solution.get_md_code()
		return res
...
if __name__ == "__main__":
		...
		write_to_md(section+".md", generate_final_data(section, md_file, new_solution))
